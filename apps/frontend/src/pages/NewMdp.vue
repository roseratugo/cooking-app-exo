...
<div class="picture">
    ...
    <nav class="bg-amber-700 ml-6 mr-6 mt-5 rounded-xl border-red-950 dark:bg-gray-900" aria-label="Menu de navigation principal">
  <div class="max-w-screen-xl flex items-center justify-between p-2">
    <img src="C:\Users\AdminVia\Downloads\M (1).png" class="h-28 sm:h-auto lg:h-48 rounded-xl" alt="Logo Miam Miam" />
    <span class="font-serif text-2xl lg:text-5xl">Miam Miam</span>
    <div class="flex items-center space-x-4">
      <!-- Bouton Home -->
      <div class="hidden sm:block">
        <router-link to="/home" >
          <button data-tooltip-target="tooltip-home" aria-label="Accueil" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-s-full dark:hover:bg-gray-800 group">
      ...
      <router-link to="/allrecipe" >
        <button data-tooltip-target="tooltip-recipes" aria-label="Toutes les recettes" type="button" class="inline-flex flex-col items-center justify-center px-5 dark:hover:bg-gray-800 group">
          <img class="w-6 h-6 mb-1 ml-5 mt-5 text-gray-500 dark:text-gray-400" src="C:\Users\AdminVia\Downloads\cook-book.png" alt="Icône de livre de recettes">
          <span class="sr-only">Toutes les recettes</span>
        </button>
      </router-link>
      <!-- Bouton Add Recipe -->
      <router-link v-if="isUserLoggedIn" to="/addrecipe" >
        <button data-tooltip-target="tooltip-cooking" aria-label="Ajouter une recette" type="button" class="inline-flex flex-col items-center justify-center px-5 dark:hover:bg-gray-800 group">
          <img class="w-6 h-6 mb-1 ml-5 mt-5 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" src="C:\Users\AdminVia\Downloads\cooking.png" alt="Icône de cuisine">
          <span class="sr-only">Ajouter une recette</span>
        </button>
      </router-link>
      <!-- Bouton Profil -->
      <router-link :to="profileRoute()" >
        <button data-tooltip-target="tooltip-profile" aria-label="Profil" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-e-full dark:hover:bg-gray-800 group">
