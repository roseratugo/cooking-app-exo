...
export default {
  ...
  async handleSubmit() {
    ...
    registerUser() {
      console.log('Registration successful', this.credentials);
      // Logic for registering user goes here
    },
    goToTop() {
...
<!-- **************fin titre modif mdp********** -->
  ...
  <div class= "max-w-4xl p-6 mt-20 ml-2 mr-2 bg-red-950 border border-red-950 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 md:mx-auto" >
    <form class="space-y-6" @submit.prevent="handleSubmit">
      ...
      <!-- Nom d'utilisateur -->
      <div>
        <label for="username" class="block mb-2 text-sm font-medium text-amber-700 dark:text-white">Nom d'utilisateur</label>
        <input type="text" v-model="credentials.username" id="username" placeholder="Pseudo amusant ..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-700 focus:border-amber-700 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" >
 ...
 <div class="md:hidden"> <!-- Masquer la barre de navigation sur les écrans de taille moyenne et plus grands -->
  <div
    class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-amber-700  border-red-950 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
