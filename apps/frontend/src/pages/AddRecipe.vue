...
export default {
  ...
  try {
    const data = {
      ...
      cooking_time: this.credentials.cooking_time,
    ...
    validateForm() {
      if (this.credentials.title.trim() === '' || this.credentials.description.trim() === '') {
        this.globalError = true;
        this.globalErrorMessage = 'Veuillez remplir tous les champs.';
      } else {
...
<!-- ******************* fin phrase d'accroche********** -->
  ...
  <span class="text-3xl lg:text-4xl xl:text-5xl font-serif italic p-4 rounded-lg text-amber-700 sm:text-center">Ajoute une recette</span>
</div>
