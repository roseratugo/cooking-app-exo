...
<template>
  ...
  <button type="button" class="text-white bg-gradient-to-br mt-10 from-red-700 to-orange-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Voir mes recettes favorites</button>
</div>
...
<footer class="bg-zinc-400 dark:bg-gray-900 ">
  <div class="mx-auto w-full max-w-screen-xl mt-32">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
      <span class="text-sm text-black dark:text-gray-300 sm:text-center" aria-label="droits reserver">© 2024 <a
          href="">Miam Miam™</a>
      </span>
