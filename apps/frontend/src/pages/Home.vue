...
<!-- ***************************************************fin modal********************************************* -->
    ...
    <div class="flex justify-center">
      <form class="max-w-md mx-auto mt-14 ml-5 mr-5 md:w-full lg:w-full xl:w-full">
        <label for="default-search"
          class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
        <div class="relative">
          <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="" fill="none"
              viewBox="0 0 20 20">
          ...
          <input type="search" id="default-search"
            class="block w-full p-4 ps-10 text-sm text-gray-900 border border-red-950 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Recette de ..." required />
          <button type="submit"
            class="text-white absolute end-2.5 bottom-2.5 bg-amber-700 hover:bg-red-950 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
        </div>
      </form>
    </div>

    <hr class="w-48 h-1 mx-auto my-4 mt-14 bg-amber-700  border-0 rounded md:my-10 dark:bg-gray-700">
    ...
    <div class="flex justify-center">
      <div class="ml- max-w-6xl">
        <a href="#"
          ...
          <h5 class="mb-4 text-3xl font-bold tracking-tight text-red-950 dark:text-white">Miam Miam c'est quoi ?</h5>
          <p class="font-normal text-lg text-gray-700 dark:text-gray-400">
            ...
            passion,
            partage et plaisir se rencontrent dans chaque plat. Que vous soyez un cuisinier amateur ou un chef
            chevronné,
            <strong class="text-red-900">Miam Miam</strong> est la plateforme idéale pour explorer, créer et partager
            des
            recettes avec des gourmets du monde entier.
            <br><br>
            <strong class="text-red-900">Cuisinez</strong> des recettes délicieuses et inspirantes, allant des
            classiques
            ...
            conseils
            pratiques pour vous garantir succès et plaisir en cuisine.
            <br><br>
            <strong class="text-red-900">Partagez</strong> vos créations culinaires avec une communauté de passionnés.
            Que
            ...
            votre passion.
            <br><br>
            <strong class="text-red-900">Savourez</strong> les recettes que vous avez préparées et découvrez de
            nouvelles
            saveurs à travers les créations des autres utilisateurs. Chaque recette est une porte ouverte sur une
            expérience
            culinaire unique et enrichissante.
            <br><br>
            ...
            <br><br>
            <strong class="text-red-900">Cuisiner, Partager, Savourer</strong> - c'est la promesse de Miam Miam.
            Embarquez
      ...
      <div class="mx-auto w-full max-w-screen-xl mt-32">
        ...
        <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
          <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a
              href="https://flowbite.com/">Miam Miam™</a>. All Rights Reserved.
          </span>
